    ...
    <div className="min-h-screen">
            ...
            <div className="lg:col-span-7">
              ...
              <FadeIn delay={0.4} y={20}>
                <div className="flex flex-col sm:flex-row items-start gap-4 mb-10">
                  <Link
                    href="/ranking"
                    className="inline-flex items-center gap-2 px-6 py-3.5 bg-emerald-700 hover:bg-emerald-700 text-white font-medium rounded-lg transition-colors active:scale-95"
                  >
                  ...
                  <Link
                    href="/generator"
                    className="inline-flex items-center gap-2 px-6 py-3.5 bg-transparent border border-zinc-700 hover:border-zinc-500 text-zinc-300 hover:text-white font-medium rounded-lg transition-colors active:scale-95"
                  >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-16 lg:py-20">
        <div className="bg-zinc-900 rounded-2xl p-10 sm:p-14 text-center text-white">
          ...
          <Link
            href="/generator"
            className="inline-flex items-center gap-2 px-8 py-3.5 bg-emerald-700 hover:bg-emerald-700 text-white font-medium rounded-lg transition-colors active:scale-95"
          >
            <Sparkles className="w-4 h-4" />
            Start Matching
            <ArrowRight className="w-4 h-4" />
