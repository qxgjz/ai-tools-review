    ...
    return new ImageResponse(
      ...
      >
        ...
        <div style={{ fontSize: 28, color: 'rgba(255,255,255,0.85)' }}>
          Six-Dimension Scoring · Expert Reviews · Smart Recommendations
        </div>
      </div>,
  ...
  return new ImageResponse(
    <div
      style={{
        ...
        display: 'flex',
        flexDirection: 'column',
        background: 'linear-gradient(135deg, #1e3a8a 0%, #2563eb 35%, #4f46e5 70%, #7c3aed 100%)',
        fontFamily: 'sans-serif',
        padding: '56px 64px',
        position: 'relative',
      }}
    >
      ...
      >
        <div style={{ fontSize: 22, color: '#6b7280', fontWeight: 500, marginBottom: 10 }}>
          {tool.vendor}
        </div>
        ...
        <div style={{ display: 'flex', alignItems: 'flex-end' }}>
          ...
          >
            / 10<div style={{ fontSize: 18, color: '#d1d5db', marginTop: 4 }}>Overall Score</div>
          </div>
        </div>
      </div>
