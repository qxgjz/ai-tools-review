...
const CATEGORY_NAMES: Record<string, string> = {
  chat: "AI Chat", writing: "AI Writing", image: "AI Image", video: "AI Video",
  audio: "AI Audio", code: "AI Coding", productivity: "AI Productivity",
  agent: "AI Agents", "agent-framework": "Agent Frameworks",
  "agent-runtime": "Agent Runtime", rag: "RAG", dev: "Dev Tools",
  "dev-tools": "Dev Tools", design: "Design", database: "Database",
  memory: "Memory", search: "AI Search", observability: "Observability",
};
...
export default function SubcategoryPage({ params }: { params: { slug: string } }) {
  ...
  const tools = (toolsData as Tool[]).filter(
    (t) => (t as any).subcategory === params.slug
  );
        ...
        <FadeIn>
          <div className="mb-8">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl">
              We tested and reviewed the best {sub.name.toLowerCase()} tools in 2026.
              Every tool is evaluated on functionality, UX, pricing, and real-world performance.
            </p>
          </div>
        </FadeIn>
