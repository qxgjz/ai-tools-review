...
export const metadata: Metadata = {
  ...
  description: "FTC-compliant affiliate disclosure for AIToolCrux. Learn how we earn through affiliate links without compromising the honesty of our AI tool reviews.",
  alternates: {
