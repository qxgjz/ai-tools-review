    ...
    <>
      {parts.map((part, i) =>
        regex.test(part) ? (
          <mark
            key={i}
            className="bg-yellow-200/80 dark:bg-yellow-500/30 text-gray-900 dark:text-yellow-200 px-0.5 rounded font-semibold"
          >
            {part}
          </mark>
        ) : (
      ...
      {!query && (
        <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm p-8 text-center">
          ...
          <p className="text-gray-500 dark:text-gray-400 mb-6">
            Enter tool name, vendor, or feature tag
          </p>
        ...
        <>
          <div className="mb-8">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Found{' '}
              <span className="font-bold text-gray-700 dark:text-gray-300">{results.length}</span>{' '}
              matching tools
            </p>
          </div>
