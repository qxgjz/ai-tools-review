...
const AUDIENCE_CONFIG: Record<AudienceSlug, {
  title: string;
  description: string;
  metaTitle: string;
  ...
  developers: {
    ...
    faqs: [
      { q: "Will AI tools replace developers?", a: "No. AI coding tools are force multipliers, not replacements. AI excels at boilerplate code, repetitive patterns, and test generation, but human developers are still needed for architecture, complex logic, security review, and product decisions. Developers who use AI tools will replace those who don't." },
      { q: "Cursor vs GitHub Copilot: which is better?", a: "GitHub Copilot is an IDE plugin that works in VS Code and JetBrains, offering high-quality inline completions. Cursor is an AI-native IDE based on VS Code with codebase understanding, multi-file edits, and AI refactoring. Use Copilot for fast inline suggestions and Cursor for larger refactoring tasks. Many developers use both." },
  ...
  "content-creators": {
    ...
    faqs: [
      { q: "Which AI tools do top YouTubers use?", a: "Most top creators use a stack: ChatGPT or Claude for scripting, Runway or Descript for editing, ElevenLabs for voiceovers, and Canva/Midjourney for thumbnails. The key is finding tools that integrate smoothly and save the most time per video." },
      { q: "Can AI-generated videos be monetized on YouTube?", a: "Yes, YouTube allows AI-generated content as long as it adds value and follows community guidelines. Clearly label AI-generated content where required. Many channels successfully use AI for voiceovers, background visuals, and editing while maintaining human creative direction." },
  ...
  students: {
    ...
    faqs: [
      { q: "Is it cheating to use AI tools as a student?", a: "It depends on how you use them and your school's policy. AI as a tutor (explaining concepts, practicing problems, getting feedback on drafts) is generally encouraged. AI to do your homework or write essays for you violates academic integrity. Always disclose AI use where required, and use it as a learning tool rather than a replacement for understanding." },
      { q: "Which free AI tool is best for studying?", a: "For most students, Claude Free offers the best balance: strong writing analysis, long context for reading papers, and generous free limits. Perplexity Free is best for research with citations. ChatGPT Free is best for general Q&A and coding help. Use all three free tiers." },
  ...
  startups: {
    ...
    faqs: [
      { q: "Which AI tools should a startup adopt first?", a: "Start with engineering tools (Cursor/Copilot) and documentation tools (Notion AI) — these have the highest ROI for early-stage teams. Add marketing tools once you have a product to promote, and customer support AI once you have real users. Don't try to adopt everything at once." },
      { q: "Can AI replace a marketing team for a startup?", a: "AI can handle 60-70% of routine marketing work (blog drafts, social posts, email sequences, basic design), but you still need someone to set strategy, review content for brand voice, and handle high-stakes campaigns. AI replaces the grunt work, not the strategic thinking." },
  ...
  writers: {
    ...
    filter: (tool) => {
      ...
      return cat === "writing" || cat === "chat" ||
             bestFor.includes("writer") || bestFor.includes("writing") || bestFor.includes("blog");
    }
  }
};
      ...
      <FadeIn delay={0.1} y={20}>
        <section className="bg-blue-50 dark:bg-blue-900/20 rounded-2xl border-l-4 border-blue-500 p-6 mb-8">
          ...
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            . We evaluated {filteredTools.length} tools based on functionality, ease of use, pricing, and real user feedback.
          </p>
        </section>
      </FadeIn>
          ...
          <ul className="space-y-2">
            {config.buyingGuide.slice(0, 4).map((tip, i) => (
              <li key={i} className="flex gap-3">
                ...
                <span className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed">{tip}</span>
              </li>
            ))}
          </ul>
        </section>
