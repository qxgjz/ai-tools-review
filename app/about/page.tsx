    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto leading-relaxed">
          Our team has spent <strong>100+ hours hands-on testing 500+ AI tools</strong>. Every
          review is based on real usage experience — we don't copy vendor descriptions.
        </p>
      ...
      <section className="mb-16">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 p-8 shadow-sm">
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
            In 2026, there are over 5,000 AI tools available, spanning chat, writing, image
            generation, coding, video, audio, and more. For users and businesses, navigating this
            vast landscape to find the right tool is overwhelming.
          </p>
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
            AIToolCrux was founded to solve this problem. We believe that{' '}
            <strong>good tool selection should be based on data, not marketing hype</strong>. Our
            mission is to provide independent, comprehensive, and actionable AI tool reviews that
            help users make informed decisions.
          </p>
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            We test every tool ourselves, use standardized test cases, and score each tool across
            six dimensions. Our reviews are free from vendor influence — we don't accept payment for
            higher ratings.
          </p>
        </div>
      </section>
      ...
      <section className="mb-16">
        ...
        <p className="text-gray-600 dark:text-gray-400 mb-6">
          We use a six-dimensional weighted scoring framework to evaluate every AI tool. Each
          dimension is scored 1-10, then weighted to produce an overall score.
        </p>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {[
            {
              dim: 'Functionality & Output Quality',
              weight: '25%',
              desc: 'Core feature completeness, output accuracy, test case coverage, consistency',
            },
            {
              dim: 'User Experience',
              weight: '20%',
              desc: 'Interface design, onboarding curve, documentation quality, response speed',
            },
            {
              dim: 'Pricing & Value',
              weight: '20%',
              desc: 'Cost transparency, free tier generosity, ROI, pricing flexibility',
            },
            {
              dim: 'Integration & Developer Experience',
              weight: '15%',
              desc: 'API quality, platform compatibility, ecosystem, developer support',
            },
            {
              dim: 'Support & Reliability',
              weight: '10%',
              desc: 'Uptime, update frequency, customer support responsiveness, community',
            },
            {
              dim: 'Ethics & Transparency',
              weight: '10%',
              desc: 'Data privacy, bias disclosure, responsible AI, transparency',
            },
          ].map((item, i) => (
            <div
              key={i}
            ...
            >
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="px-2 py-0.5 bg-emerald-50 dark:bg-emerald-900/20 text-emerald-600 dark:text-emerald-400 rounded text-xs font-bold">
                  {item.weight}
                </span>
              </div>
        ...
        <div className="mt-6 p-4 bg-amber-50 dark:bg-amber-900/10 rounded-xl border border-amber-200 dark:border-amber-800">
          <p className="text-sm text-amber-800 dark:text-amber-300">
            <strong>Grade Mapping:</strong> S (9.0+) | A (8.0-8.9) | B (7.0-7.9) | C (6.0-6.9) | D
            (5.0-5.9) | F ({'<5.0'})
          </p>
        </div>
      </section>
      ...
      <section className="mb-16">
        ...
        <div className="bg-teal-50 dark:bg-teal-900/10 rounded-2xl border border-teal-200 dark:border-teal-800 p-8">
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
            AIToolCrux may contain affiliate links. If you purchase a tool through these links, we
            may earn a commission at no additional cost to you.
          </p>
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
            <strong>This does not affect our ratings or reviews.</strong> Affiliate revenue helps us
            maintain the site and continue producing independent reviews. We only recommend tools
            that we have tested and believe provide value to our readers.
          </p>
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            We clearly disclose affiliate relationships on every review page, in accordance with FTC
            guidelines.
          </p>
        </div>
      </section>
      ...
      <section className="mb-16">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 p-8 shadow-sm">
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
            We welcome feedback, corrections, and suggestions. If you disagree with a review, found
            an error, or want to suggest a tool for review, please reach out.
          </p>
          <div className="space-y-3">
            <div className="flex items-center gap-3">
              <Mail className="w-5 h-5 text-gray-400" />
              <a
                href="mailto:editor@aitoolcrux.com"
                className="text-emerald-600 dark:text-emerald-400 hover:underline"
              >
                editor@aitoolcrux.com
              </a>
            </div>
            <div className="flex items-center gap-3">
              ...
              <a
                ...
                className="text-emerald-600 dark:text-emerald-400 hover:underline"
              >
                github.com/qxgjz/ai-tools-review
              </a>
            </div>
          </div>
        </div>
      ...
      <section className="text-center">
        <div className="bg-gradient-to-br from-emerald-600 to-teal-600 rounded-3xl p-10 sm:p-12 text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/ranking"
              className="inline-flex items-center justify-center gap-2 px-6 py-3.5 bg-white text-emerald-700 font-bold rounded-xl hover:shadow-lg transition-shadow"
            >
              View Top Rated Tools
            </Link>
            <Link
              href="/blog"
              className="inline-flex items-center justify-center gap-2 px-6 py-3.5 bg-white/15 text-white font-bold rounded-xl border border-white/30 hover:bg-white/25 transition-colors"
            >
              Read Latest Reviews
            </Link>
          </div>
