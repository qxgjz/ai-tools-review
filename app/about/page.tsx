...
export const metadata: Metadata = {
  ...
  description: "AIToolCrux provides expert, unbiased AI tool reviews and comparisons. Our mission is to help you find the perfect AI tools with transparent, data-driven eval...",
  alternates: {
