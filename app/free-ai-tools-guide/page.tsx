    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12">
      ...
      <div className="mb-12 text-center">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-500 max-w-2xl mx-auto">
          Every tool listed below has a genuinely free tier or free plan. We tested them all — no
          upsell traps, no "free trial" that vanishes in 7 days.
        </p>
      </div>
      ...
      <div className="space-y-10">
        {categories.map((cat) => {
          ...
          const catPosts = cat.slugs.map((slug) => postMap[slug]).filter(Boolean);
      ...
      <div className="mt-16 p-6 bg-emerald-50 dark:bg-emerald-900/10 rounded-xl border border-emerald-200 dark:border-emerald-900/30 text-center">
        <p className="text-sm text-emerald-800 dark:text-emerald-300">
          💡 All tools on this page were hands-on tested by our team. Pricing and free tiers change
          — always verify on the official site before signing up.
        </p>
      </div>
    </div>
  );
