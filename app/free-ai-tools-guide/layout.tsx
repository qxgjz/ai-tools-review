...
export const metadata: Metadata = {
  ...
  description: "Discover the best free AI tools in 2026. Expert-curated list of free ChatGPT, Midjourney, Claude and more. No credit card required, start using today.",
  alternates: {
