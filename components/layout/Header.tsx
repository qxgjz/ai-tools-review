...
import { Sparkles, LayoutGrid, Trophy, Search as SearchIcon, GitCompare } from "lucide-react";
    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between gap-4">
        ...
        <nav className="flex items-center gap-1 sm:gap-2">
          <Link
            href="/"
            className="p-2 sm:px-3 sm:py-2 rounded-lg text-sm font-medium text-gray-600 hover:text-blue-600 hover:bg-blue-50 transition-colors"
          >
